...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(91), __webpack_require__(333)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_modules_util__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_modules_epi_models__ = __webpack_require__(330);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_config__ = __webpack_require__(329);
const _ = __webpack_require__(64)





let epiModel = __WEBPACK_IMPORTED_MODULE_1__src_modules_epi_models__["a" /* epiModels */][0]
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(11)(proto, TO_PRIMITIVE, __webpack_require__(132));
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return epiModels; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pop_js__ = __webpack_require__(331);



class TbModel extends __WEBPACK_IMPORTED_MODULE_1__pop_js__["a" /* default */] {
  constructor(id) {
    super(id)
    this.id = id
    ...
    this.param = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.cloneDeep(this.defaultParams)
  ...
  calcExtraParams() {
    ...
    if (__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.has(this.param, 'treatmentSuccessRatio')) {
      this.param.deathRate2 =
        this.param.activeTreatmentRate / this.param.treatmentSuccessRatio -
        this.param.activeTreatmentRate
    }

    if (__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.has(this.param, 'treatmentEarlyRateYear')) {
      this.param.treatmentEarlyRate = this.param.treatmentEarlyRateYear / 365
    }
    if (__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.has(this.param, 'treatmentRemoteRateYear')) {
      this.param.treatmentRemoteRate = this.param.treatmentRemoteRateYear / 365
    }
  }

  calcVars() {
    this.var.population = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.sum(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.values(this.compartment))
    this.var.rateForce =
...
class BaseModel {
   ...
   */
  getGuiParams() {
    return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.cloneDeep(this.guiParams)
  }
  ...
  getInterventionParams() {
    if (this.interventionParams.length > 0) {
      return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.cloneDeep(this.interventionParams)
    } else {
      return []
    }
  }
   ...
   */
  initCompartments() {
    this.keys = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.keys(this.compartment)
  ...
  clearSolutions() {
    ...
    this.solution = {}
    for (let key of __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.keys(this.compartment)) {
      this.solution[key] = []
    }
    for (let key of __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.keys(this.var)) {
      this.solution[key] = []
    }
  ...
  checkEvents() {
    this.calcVars()
    let varKeys = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.keys(this.var)
    for (let varEvent of this.varEvents) {
      let varEventKey = varEvent[2]
      if (!__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.includes(varKeys, varEventKey)) {
        console.log(
    ...
    for (let paramEvent of this.paramEvents) {
      ...
      let paramKeys = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.keys(this.param)
      if (!__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.includes(paramKeys, paramEventKey)) {
        console.log(
  ...
  integrateStep(dTime) {
    ...
    for (let key of this.keys) {
      this.delta[key] += this.dTime * this.flow[key]
    }
  ...
  run(nStep = 30, dTimeInDay = 1) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.times(nStep, () => {
      this.clearDelta()
...
/* unused harmony default export */ var _unused_webpack_default_export = ({
  ...
  isStringInStringList(str, testStrList) {
    for (let testStr of testStrList) {
      if (__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.includes(str, testStr)) {
        return true
      }
    }
    return false
  ...
  copyArray(destArray, sourceArray) {
    destArray.length = 0
    for (let entry of sourceArray) {
